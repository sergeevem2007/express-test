export default {
	...
	points: [
		{ img: "/src/assets/img/points/1.png", text:"Текст <span class=\"text-primary\">Текст текст</span> Текст текст Текст"},
		{ img: "/src/assets/img/points/2.png", text:"Текст Текст Текст Текст Текст </br>Текст Текст </br>Текст Текст Текст"},
		{ img: "/src/assets/img/points/3.png", text:"Текст Текст Текст </br>Текст"},
